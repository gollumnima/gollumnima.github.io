---
title: "wecode 7주차_1일 TIL_리액트 상태값 변경+프로젝트 예시"
...
tags:
  ...
  - "react"
  - "위코드"
description: "위코드 35일차. 1차 프로젝트를 마치며 다시금 state와 props로 데이터를 변경하는 법을 정리해보았다. (with 1차 프로젝트 코드)"
---
...
<br />저 당시엔 state와 props에 대한 이해도가 없는 채로 그냥 알아야 적용하니깐.. 주입식으로 정리했던 것 같다.
